package com.neppplus.keepthetime_20211121_cjk.adatpers
...
import com.neppplus.keepthetime_20211121_cjk.ViewFriendListActivity
...
class RequestedRecyclerAdapter(val mContext: Context, val mList:List<UserData>) :  RecyclerView.Adapter<RequestedRecyclerAdapter.RequestedFriendViewHolder>(){
    ...
    inner class RequestedFriendViewHolder(row: View) : RecyclerView.ViewHolder(row){
        ...
        fun bind(data:UserData) {
            ...
            val ocl = View.OnClickListener {
                ...
                (mContext as ViewFriendListActivity).apiService
                    .putRequestAccepOrDenyFriendRequest(data.id, tag)
